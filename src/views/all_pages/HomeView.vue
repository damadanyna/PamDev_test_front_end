<template>
  <div class="flex w-full flex-col">
    ...
    <div class=" bg_1 w-full  px-20 config_h   flex-col flex ">
      <div class=" z-20 text-white text-9xl ajust_text flex flex-col  ">
        <span class="font_rufin">Healthy Eating </span>
        <span class="font_rufin">is important</span>
        <span class="font_rufin">part of lifestyle</span>
        <div class=" flex flex-col mt-6 text-lg font-normal ">
          <span class="font_lato">Lorem ipsum dolor sit amet, consectetur adipiscing</span> 
          <span class=" font_lato">elit. Neque congue arcu</span>
        </div>
      </div>
      <div class=" z-10">
        <img class=" absolute ajuster  right-10 w" src="../../assets/image/home/image_1.png" alt="photo">
      </div>
      <div class=" flex">
        <div class=" animate-pulse -ml-52 ajust_text_2 flex items-center transform rotate-90 ">
          <span class="font_rufin text-3xl text-white">Scroll</span>
          <span class=" ml-3 w-96 border-b-2 h-1 border-dashed "></span>
        </div>
      </div>
      <div class="  w-full z-20 flex justify-center">
        <img class=" w-48 mx-6 h-auto" src="../../assets/image/home/spices1.png" alt="photo">
        <img class=" w-48 mx-6 h-auto" src="../../assets/image/home/spices2.png" alt="photo">
        <img class=" w-48 mx-6 h-auto" src="../../assets/image/home/spices3.png" alt="photo">
      </div>
      <div class=" mt-40 flex justify-between">
      <div class=" w-1/2 flex flex-col">
        <img class=" w-full" src="../../assets/image/home/Image_2.png" alt="photo">
        <span class=" mt-7 font_rufin w-1/2 text-5xl text-white ">Start to plan your diet today</span>
        <span class=" mt-7 w-3/4 text-xl text-white ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque congue arcu</span>
      </div> 
      <div class=" w-1/2 pl-72 flex flex-col text-white text-lg">
        <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque congue arcu</span>
        <img class=" mt-20" src="../../assets/image/home/Image_3.png" alt="photo">
      </div> 
      </div>
    </div>
    <div class="flex flex-col h-full w-full px-20 bg-white">
      <div class=" flex flex-row w-3/5 items-center">
        <div class=" mt-48 flex flex-col ">
          <span class=" font-bold font_rufin text-black text-7xl">Our Menu</span>
          <span class=" font_rufin text-gray-500 w-3/4 text-base  font_lato">This is a section of your menu. Give your section a brief description</span>
        </div>
        <div class=" ">
          <img class=" absolute w-1/2 config_mt" src="../../assets/image/home/Image_.png" alt="photo">
        </div>
      </div>
    </div>
    <div class=" flex flex-col ajust_3 px-20">
      <div class=" flex flex-row justify-between ">
        <div class=" flex flex-col w-full pr-8">
          <span class=" w-full border-b-4 text-right text-3xl font_rufin font-bold border-black border-dotted">$ <span class=" text-xl relative -ml-2">20</span></span>
          <span class="  text-5xl relative mt-4 font_rufin font-semibold w-4/5 ">Deep Sea Snow White Cod Fillet</span>
          <span class=" mt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
        </div>
        <div class=" flex flex-col w-full pl-8">
          <span class=" w-full border-b-4 text-right text-3xl font_rufin font-bold border-black border-dotted">$ <span class=" text-xl relative -ml-2">22</span></span>
          <span class="  text-5xl  relative mt-4 font_rufin font-semibold ">Steak With Rosemary Butter</span>
          <span class=" mt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
        </div>
      </div>
      <div class=" flex flex-row justify-between my-16 ">
        <div class=" flex flex-col w-full pr-8">
          <span class=" w-full border-b-4 text-right text-3xl font_rufin font-bold border-black border-dotted">$ <span class=" text-xl relative -ml-2">I8</span></span>
          <span class="  text-5xl  relative mt-4 font_rufin font-semibold  ">Cucumber Salad</span>
          <span class=" mt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
        </div>
        <div class=" flex flex-col w-full pl-8">
          <span class=" w-full border-b-4 text-right text-3xl font_rufin font-bold border-black border-dotted">$ <span class=" text-xl relative -ml-2">90</span></span>
          <span class="  text-5xl  relative mt-4 font_rufin font-semibold ">Natural Wine Pairing</span>
          <span class=" mt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
        </div>
      </div>
    </div>
    <div class="flex bg_home w-full h-full fex-row px-16">
      <div class=" w-full flex justify-between flex-row mt-20">
        <div class=" flex  w-2/3">
          <div class=" -mt-1 z-0 absolute" >
            <svg class=" w-56 -mt-24"  width="406" height="336" viewBox="0 0 406 336" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <img class=" z-20 " src="../../assets/image/home/Image_man.png" alt="photo">
        </div>
        <div class=" w-1/2   flex flex-col">
          <span class="font-bold font_rufin text-7xl">Excellent </span>
          <span class="font-bold font_rufin text-7xl">cook</span>
          <span class=" font-medium text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet. Turpis egestas ultricies purus auctor tincidunt lacus nunc. </span>
          <div class=" w-full flex justify-center">
            <svg class=" w-80" width="495" height="430" viewBox="0 0 495 430" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="px-16 flex w-full h-full py-44 justify-center ">
      <div class=" flex flex-col justify-center items-center mx-7 ">  
        <img class="  w-36" src="../../assets/image/home/CircleIcon.png" alt="photo">
        <span class=" text-4xl font_rufin text-center">Premium Quality</span>
        <span class="text-center text-gray-500 text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque congue arcu</span>
      </div>
      <div class=" flex flex-col justify-center items-center mx-7 ">  
        <img class="  w-36" src="../../assets/image/home/CircleIcon-1.png" alt="photo">
        <span class=" text-4xl font_rufin text-center">Seasonal Vegetables</span>
        <span class="text-center text-gray-500 text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque congue arcu</span>
      </div>
      <div class=" flex flex-col  justify-center items-center mx-7">  
        <img class="  w-36" src="../../assets/image/home/CircleIcon-2.png" alt="photo">
        <span class=" text-4xl font_rufin" text-center>Fresh Fruit</span>
        <span class=" text-center text-gray-500 text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque congue arcu</span>
      </div>
    </div>
    <div class="px-16 flex w-full py-36 justify-center ">
      <div class=" w-full flex flex-col h-full justify-center items-center mx-7  ">  
        <div class="flex w-full justify-end">
          <button class=" absolute mt-2 mr-2 px-9 py-2 text-base outline-none font_rufin ">Fashion</button>
        </div>
        <img class=" " src="../../assets/image/home/Feature-Image.png" alt="photo">
        ...
        <div class=" flex w-full items-center  py-6">
          ...
          <li class=" list_2 ml-3"><span class=" relative ">2 comments</span></li>
        </div>
        <div class=" border-b-4 border-black border-dotted pb-4 text-5xl font_rufin font-medium ml-4">
          <span class="">
            Fruit and vegetables and protection against diseases
          </span>
        </div>
        <div class=" py-4 flex text-left w-full ml-4">
          <span class=" text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
        </div>
      ...
      <div class=" w-full flex flex-col h-full justify-center items-center mx-7  ">  
        ...
        <img class=" " src="../../assets/image/home/Feature-Image-1.png" alt="photo">
        <div class=" flex w-full items-center  py-6">
    ...
    <!-- formulaire -->
    <div class="bg_2 w-full pt-16 pb-36 flex-col items-center flex h-screen">
      <span class=" font_rufin text-7xl">Make a Reservation</span>
      <span class=" text-gray-500 mt-3">Get in touch with restaurant</span>
      <div class=" flex flex-row ">
        <div class=" mt-24" >
          <select class=" px-20 bg-transparent border border-gray-600 py-2 mx-3" name="" id="">
            <option value="">09/08/2022</option>
            <option value="">10/08/2022</option>
            <option value="">11/08/2022</option>
          </select>
          <select class=" px-20 bg-transparent border border-gray-600 py-2 mx-3" name="" id="">
          ...
          <select class=" px-20 bg-transparent border border-gray-600 py-2 mx-3" name="" id="">
            <option value="">2prs</option>
            <option value="">4prs</option>
            <option value="">6prs</option>
          </select>
        </div>
      </div>
      <button class=" px-12 py-2 text-white font_rufin button1 mt-16 ">Book Now</button>
    </div>
    <div class=" w-full pt-16 pb-36 flex-col items-center flex h-screen">
      <span class=" font_rufin text-7xl">Calories Energy </span>
      <span class=" font_rufin text-7xl"> Balance</span>
      <span class=" text-gray-500 mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </span>
      <div class=" flex flex-row mt-12">
        <div class=" mx-6 hover:opacity-50 cursor-pointer">
          <span class=" font_rufin color_txt text-2xl absolute mt-5 ml-5 font-semibold"> Starters</span>
          <img class=" w-80 " src="../../assets/image/home/images_.png" alt="photo">
        </div>
        <div class=" mx-6 hover:opacity-50 cursor-pointer">
          <span class=" font_rufin color_txt text-2xl absolute mt-5 ml-5 font-semibold"> Mains</span>
          <img class=" w-80 " src="../../assets/image/home/images_2.png" alt="photo">
        </div>
        <div class=" mx-6 hover:opacity-50 cursor-pointer">
          <span class=" font_rufin color_txt text-2xl absolute mt-5 ml-5 font-semibold"> Soups</span>
          <img class=" w-80 " src="../../assets/image/home/images_3.png" alt="photo">
        </div>
      </div>
    </div>
    <div class=" px-20">
      <div class=" w-3/5 pt-40 pb-7">
        <span class=" font_rufin text-3xl  font-semibold ">“ Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus lorem id penatibus imperdiet. Turpis egestas ultricies purus  Lorem ipsum dolor sit amet.</span>
      </div>
      <div class="flex flex-row w-3/4 items-center justify-between">
        <div class=" w-3/5 pt-7 flex-row flex items-center pb-20">
          <img class=" w-28" src="../../assets/image/home/avatar_3.png" alt="photo">
          <div class="flex flex-col ml-10">
            <span class=" text-3xl font_rufin">John Doe</span>
            <span class=" text-gray-500">Blogger</span>
          </div>
        </div>
        <span class=" font_rufin font-bold text-xl"> 2/ <span class=" text-3xl">3</span>
        </span>
      </div>
    </div>
  </div>
