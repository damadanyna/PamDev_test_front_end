<template>
  <div class="flex w-full flex-col">
    ...
    <div class=" bg_1 w-full  px-20 config_h   flex-col flex ">
      ...
      <div class=" z-10">
        <img class=" absolute ajuster  right-10 w" src="../assets/image/home/image_1.png" alt="">
      </div>
      <div class=" flex">
      ...
      <div class="  w-full z-20 flex justify-center">
        <img class=" w-48 mx-6 h-auto" src="../assets/image/home/spices1.png" alt="">
        <img class=" w-48 mx-6 h-auto" src="../assets/image/home/spices2.png" alt="">
        <img class=" w-48 mx-6 h-auto" src="../assets/image/home/spices3.png" alt="">
      </div>
      <div class=" mt-40 flex justify-between">
      <div class=" w-1/2 flex flex-col">
        <img class=" w-full" src="../assets/image/home/Image_2.png" alt="">
      ...
      <div class=" w-1/2 pl-72 flex flex-col text-white text-lg">
        ...
        <img class=" mt-20" src="../assets/image/home/Image_3.png" alt="">
      </div> 
      </div>
    </div>
    <div class="flex flex-col h-full w-full px-20 bg-white">
      <div class=" flex flex-row w-3/5 items-center">
        ...
        <div class=" ">
          <img class=" absolute w-1/2 config_mt" src="../assets/image/home/Image_.png" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="flex bg_home w-full h-full fex-row px-16">
      <div class=" w-full flex justify-between flex-row mt-20">
        <div class=" flex  w-2/3">
          ...
          <img class=" z-20 " src="../assets/image/home/Image_man.png" alt="">
        </div>
        <div class=" w-1/2   flex flex-col">
    ...
    <div class="px-16 flex w-full h-full py-44 justify-center ">
      <div class=" flex flex-col justify-center items-center mx-7 ">  
        <img class="  w-36" src="../assets/image/home/CircleIcon.png" alt="">
      ...
      <div class=" flex flex-col justify-center items-center mx-7 ">  
        <img class="  w-36" src="../assets/image/home/CircleIcon-1.png" alt="">
        <span class=" text-4xl font_rufin text-center">Seasonal Vegetables</span>
        <span class="text-center text-gray-500 text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque congue arcu</span>
      </div>
      <div class=" flex flex-col  justify-center items-center mx-7">  
        <img class="  w-36" src="../assets/image/home/CircleIcon-2.png" alt="">
    ...
    <div class="px-16 flex w-full py-36 justify-center ">
      <div class=" w-full flex flex-col h-full justify-center items-center mx-7  ">  
        ...
        <img class=" " src="../assets/image/home/Feature-Image.png" alt="">
        
        <div class=" flex w-full items-center  py-6">
          <img class=" w-16" src="../assets/image/home/Avatar_1.png" alt="">
      ...
      <div class=" w-full flex flex-col h-full justify-center items-center mx-7  ">  
        ...
        <img class=" " src="../assets/image/home/Feature-Image-1.png" alt="">
        <div class=" flex w-full items-center  py-6">
          <img class=" w-16" src="../assets/image/home/Avatar_.png" alt="">
          <span class="list_2 relative ">Julie Christie</span>
          <li class=" list_2 ml-3"><span class=" relative ">October 17,2021</span></li>
          <li class=" list_2 ml-3"><span class=" relative ">3:33 pm</span></li>
          <li class=" list_2 ml-3"><span class=" relative ">2 comments</span></li>
    ...
    <div class=" w-full pt-16 pb-36 flex-col items-center flex h-screen">
      ...
      <div class="flex flex-row w-3/4 items-center justify-between">
        <div class=" w-3/5 pt-7 flex-row flex items-center pb-20">
          <img class=" w-28" src="../assets/image/home/avatar_3.png" alt="">
          <div class="flex flex-col ml-10">
            <span class=" text-3xl font_rufin">John Doe</span>
            <span class=" text-gray-500">Blogger</span>
          </div>
        </div>
        <span class=" font_rufin font-bold text-xl">
          2/ <span class=" text-3xl">3</span>
        </span>
      </div>
    </div>
  </div>
